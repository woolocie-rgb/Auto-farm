        ...
        <div className="flex bg-slate-100 p-1 rounded-xl border border-slate-200">
          <button
            ...
            className={`px-4 py-2 rounded-lg text-xs font-black transition-all cursor-pointer ${
              activeTab === "browse" ? "bg-white text-emerald-600 shadow-sm" : "text-slate-550 text-slate-500 hover:text-slate-800"
            }`}
          >
            Đọc Hướng Dẫn
          </button>
          <button
            ...
            className={`px-4 py-2 rounded-lg text-xs font-black transition-all cursor-pointer ${
              activeTab === "writer" ? "bg-white text-emerald-600 shadow-sm" : "text-slate-550 text-slate-500 hover:text-slate-800"
            }`}
          >
          ...
          {selectedTutorial ? (
            ...
            <div className="space-y-4 animate-fade-in bg-slate-50 p-6 sm:p-8 rounded-2xl border border-slate-250">
              ...
              <div className="space-y-2">
                <span className="inline-block text-[9px] text-emerald-700 font-black uppercase px-2 py-0.5 rounded bg-emerald-50 border border-emerald-100">
              ...
              {selectedTutorial.hasAffiliateDisclosure && (
                <div className="flex items-start gap-3 bg-emerald-50 border border-emerald-100 p-4 rounded-xl text-xs text-emerald-900">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              {tutorials.map((tut) => (
                <div
                  ...
                  className="bg-white border border-slate-200 p-5 rounded-2xl cursor-pointer hover:border-emerald-300 hover:shadow-md hover:bg-slate-50/50 transition-all flex flex-col justify-between group"
                >
                  <div className="space-y-3">
                    <div className="flex items-center justify-between">
                      <span className="text-[9px] uppercase font-black text-emerald-700 bg-emerald-50 border border-emerald-100 py-0.5 px-2 rounded">
                        {tut.category}
                      </span>
                    ...
                    <h4 className="text-sm font-black text-slate-800 group-hover:text-emerald-600 transition-colors line-clamp-2">
                      {tut.title}
                    </h4>
                  ...
                  <div className="flex items-center justify-between mt-5 pt-3 border-t border-slate-100">
                    ...
                    <span className="text-xs text-emerald-600 font-black flex items-center gap-1 group-hover:translate-x-1 transition-transform">
        ...
        <div className="space-y-6 text-left">
          <div className="bg-slate-100 p-5 sm:p-6 border border-slate-200 rounded-2xl space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full bg-white border border-slate-200 rounded-xl py-2 px-3 text-xs text-emerald-600 outline-none font-mono font-bold shadow-sm"
            ...
            <button
              ...
              className="w-full bg-emerald-500 hover:bg-emerald-600 text-white font-black py-3 px-4 rounded-xl text-xs flex items-center justify-center gap-2 cursor-pointer shadow-sm disabled:opacity-50"
            >
              {isGenerating ? (
                <>
